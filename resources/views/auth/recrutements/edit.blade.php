...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <form action="{{ route('recrutement.update', $recrutement->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method("PATCH")
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="title" name="title"
                            value="{{$recrutement->title}}"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 @error('title') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <select id="department" name="department_id"
                            ...
                            @foreach($departements as $dep)
                                <option value="{{ $dep->id }}"
                                    {{ $dep->id == $recrutement->department_id ? 'selected' : '' }}>
                                    {{ $dep->name }}
                                </option>                
                            @endforeach
                </select>
                    ...
                    <div>
                        ...
                        <input type="text" id="location" name="location"
                            value="{{ $recrutement->location }}"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 @error('location') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="date" id="deadline" name="deadline"
                            value="{{ $recrutement->deadline }}"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 @error('deadline') border-red-500 @enderror">
                            @error('deadline')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Missions, responsabilités, avantages...">{{ $recrutement->description }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="requirements" name="requirements" rows="4"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 resize-none @error('requirements') border-red-500 @enderror"
                            placeholder="- Bac+5 en informatique&#10;- 3 ans d&#39;expérience minimum&#10;- Maîtrise de React et Node.js&#10;- Anglais professionnel">{{ $recrutement->requirements}}</textarea>
