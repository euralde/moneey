...
<div class="max-w-7xl mx-auto">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <button id="openUsersModal" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all shadow-sm">
...
<!-- Modal Utilisateur -->
    <div id="UsersModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
        <div class="absolute inset-0 modal-backdrop" id="modalBackdrop"></div>
            ...
            <div class="flex justify-between items-center p-5 border-b">
                <h3 class="text-lg font-semibold" id="modalTitle">Ajouter un utilisateur</h3>
    ...
    <div id="UsersModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
        ...
        @include('auth.utilisateurs.edit_users')
...
<script>
    ...
    function resetModal() {
        ...
        document.getElementById('profil').value = 'gerant';
