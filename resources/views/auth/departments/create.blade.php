...
@section('content')
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Ajouter un département</h2>
...
<<<<<<< HEAD
                        ...
                        placeholder="Titre du département" name="name" >
                    @error('name')
=======
...
<<<<<<< HEAD
                        placeholder="Nom du département" name="name" required>
                    @error('name')
=======
                        placeholder="Titre du département" name="name" required>
                    @error('title')
>>>>>>> bf7d0a951253c09bd633ab7f74be4cf4b73980e0
